...
-- 初始化-角色信息表数据
-- ----------------------------
INSERT INTO system_role (id, name, sort, del_flag, system_role.menu_check_strictly, create_by, create_time, update_by, update_time)
VALUES (1, 'admin', 1, '0', 1, 1, '2024-11-22 08:36:41', 1, '2024-11-27 08:36:41');
INSERT INTO system_role (id, name, sort, menu_check_strictly, del_flag, create_by, create_time, update_by, update_time)
...
create table if not exists `menuDO` (
...
-- 初始化-菜单表数据
-- ----------------------------
INSERT INTO `menuDO` (id, title, parent_id, sort, component, if_frame, type, visible, status, create_by, create_time, update_by, update_time)
...
INSERT INTO system_resource (`id`, `name`, `url`, `category_id`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (27, '后台菜单管理', '/menuDO/**', 4, NULL, '2020-02-07 16:48:48', NULL, '2020-02-07 16:48:48');
...
create table if not exists `system_resource_category` (
...
create table if not exists `system_role_resource_relation` (
    role_id         bigint(20)      not null        comment '角色ID',
...
create table if not exists `resume_problemset` (
...
-- 初始化-题库表数据
-- ----------------------------
INSERT INTO resume_problemset (`id`, `title`, `description`, `picture`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`)
...
-- 初始化-题目表数据
-- ----------------------------
INSERT INTO resume_question (`id`, `title`, `content`, `answer`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`)
...
-- 初始化-题目标签表数据
-- ----------------------------
INSERT INTO resume_tag (id, name, del_flag, create_by, create_time, update_by, update_time)
