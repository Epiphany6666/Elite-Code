...
public class LoginUserVO {
    ...
    public String toString() {
        return "LoginUserVO{userId = " + id + ", userAccount = " + account + ", nickName = " + nickName + ", userAvatar = " + avatar + ", userProfile = " + profile + ", userRoles = " + roles + ", createBy = " + createBy + ", createTime = " + createTime + ", updateBy = " + updateBy + ", updateTime = " + updateTime + "}";
    }
}
